    ...
    Tables: {
      ...
      feed_follows: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "feed_follows_following_user_id_fkey"
      ...
      platform_analytics: {
        ...
        Relationships: [
          {
            foreignKeyName: "platform_analytics_creator_user_id_fkey"
      ...
      user_plan_purchases: {
        ...
        Relationships: [
          {
            foreignKeyName: "user_plan_purchases_creator_user_id_fkey"
            columns: ["creator_user_id"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
