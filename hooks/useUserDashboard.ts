 ...
 *
 * Manages fetching and state for user dashboard data
...
/**
 * Hook for fetching and managing user dashboard data
 *
...
export function useUserDashboard(
  ...
  const [data, setData] = useState<ApiUserDashboard | null>(null)
